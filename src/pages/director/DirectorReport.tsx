...
function DirectorReport() {
  ...
  const cycles = [
    ...
    { id: 'junior', label: 'Collège (6ème - 3ème)' },
    { id: 'senior', label: 'Lycée (2nde - Terminale)' }
  ];
  ...
  const indicators = [
    ...
    { id: 'option_performance', label: 'Performance par option' }
  ];
  ...
  const handleExport = (format: string) => {
    ...
    alert(`Rapport exporté en ${format} pour ${schoolName}, année ${selectedYear}, cycle ${selectedCycle}`);
  };
        ...
        <div className="border border-gray-200 rounded-lg p-4 mb-6">
          <div className="text-center mb-4">
            <h2 className="text-xl font-bold text-gray-800">
              {schoolName} - Rapport de performance {selectedYear}
            </h2>
            <p className="text-gray-500">
              {cycles.find(c => c.id === selectedCycle)?.label || 'Tous les cycles'} | Généré le {new Date().toLocaleDateString()}
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            {selectedIndicators.includes('class_distribution') && (
              <div className="p-3 bg-gray-50 rounded-md">
                <h3 className="font-medium mb-2">Répartition par classe</h3>
                <div className="h-20 bg-gray-200 rounded flex items-center justify-center text-gray-400">
